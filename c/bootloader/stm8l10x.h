...
#define __STM8L10X_STDPERIPH_VERSION_MAIN   ((uint8_t)0x01)                                  
/*!< [15:8]  STM8L10x Standard Peripheral Library sub1 version */
#define __STM8L10X_STDPERIPH_VERSION_SUB1   ((uint8_t)0x01)
/*!< [7:0]  STM8L10x Standard Peripheral Library sub2 version */
#define __STM8L10X_STDPERIPH_VERSION_SUB2   ((uint8_t)0x00) 
/*!< STM8L10x Standard Peripheral Library version number */
#define __STM8L10x_STDPERIPH_VERSION       ((uint32_t)(__STM8L10X_STDPERIPH_VERSION_MAIN <<(uint32_t)16)\
                                             | (__STM8L10X_STDPERIPH_VERSION_SUB1 <<(uint32_t) 8)\
                                             | __STM8L10X_STDPERIPH_VERSION_SUB2)
...
#define AWU_CSR_MR    ((uint8_t)0x02) /*!< Master Reset mask */
...
#define CLK_PCKENR_QST     ((uint8_t)0x80) /*!< Peripheral Clock Enable 1, QST */
...
/*============================== Interrupts ====================================*/
 ...
 #define wfe() {asm("wfe");} /* Wait for event */
